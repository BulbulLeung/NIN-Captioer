...
export function DeleteConfirmDialog({ open, fileName, onConfirm, onCancel }: Props) {
    ...
    >
      ...
      >
        ...
        <p className="modal-text">
          Delete &quot;{fileName}&quot; and its .txt caption file? Files will be moved to the Recycle Bin.
        </p>
